    ...
    <section class="vh-100">
        <div class="container-fluid h-100">
            <div style="color: white" class="row d-flex justify-content-center align-items-center h-100">
                <div class="w-50">
                    <img src="../public/images/draw.webp"
                        class="img-fluid" alt="Sample image">
                </div>
                <div style="background-color: #99BDF8" class="h-100 w-50 d-flex justify-content-center align-items-center">
                    <form action="../controllers/LoginController.php" method="POST">
                        ...
                        <div data-mdb-input-init class="form-outline mb-4">
                            <input type="text" name="username" id="form3Example3" class="form-control form-control-lg fs-6"
                                placeholder="Insira seu usuário" />
                        </div>
                        <div data-mdb-input-init class="form-outline mb-3">
                            <input type="password" name="password" id="form3Example4" class="form-control form-control-lg fs-6"
